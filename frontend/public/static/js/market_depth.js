/**
 * Market Depth.js - Unified Param System Implementation
 * 
 ...
 * 
 * Bar charts use param_0 for price visualization as per unified standards.
 */
...
$(document).ready(function () {
    ...
    if (page_access[2] == 0) {
        if (page_access[4]['p1'] == 1) {

            $('.dataTableMd tbody').empty();
            ...
            function populateTableBodies() {
                var tableIds = ["depth_1_highpowstocks", "depth_2_intradayboost", "depth_3_toplevelstocks", "depth_4_lowlevelstocks", "depth_5_topgainer", "depth_6_toploser"];

                var marketDepthData = jsonData.market_depth_table;

                tableIds.forEach(tableId => {
                    var tableBody = document.getElementById(tableId + '_tbody');

                    marketDepthData.forEach(item => {
                ...
                dataSet = jsonData.market_depth_chart;
